...
export default function AuctionGoogleSheetsSync({
    ...
    try {
      ...
      if (error.message.includes('Route not found') || error.message.includes('404')) {
        ...
        try {
          ...
          try {
            const { getSyncStatusNoAuth } = await import('@/lib/auctions-api')
  ...
  if (loading && !syncing) {
    return (
      <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl p-6 overflow-y-scroll h-screen">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            onClick={() => {
              ...
              import('@/lib/auctions-api').then(({ testBackendConnectivity }) => {
          ...
          <button
            onClick={() => {
              ...
              import('@/lib/auctions-api').then(({ debugSyncManager }) => {
          ...
          <button
            onClick={() => {
              ...
              import('@/lib/auctions-api').then(({ getSyncStatusNoAuth }) => {
